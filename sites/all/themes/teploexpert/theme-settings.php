 ...
 */
function teploexpert_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['teploexpert_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('teploexpert sample setting'),
  '#default_value' => theme_get_setting('teploexpert_example'),
